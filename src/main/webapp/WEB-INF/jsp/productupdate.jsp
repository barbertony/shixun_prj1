...
<form action="" method="post" enctype="multipart/form-data">
    ...
    <br/>
    <span>商品小标题</span>
    <input type="text"name="subtitle" value=${updateProduct.subtitle}>
    <br/>
    <span>商品类别:</span>
    ...
    <br/>
    <span>detail:</span>
    <input type="text"name="detail" value=${updateProduct.detail}>
    <br/>
    <span>价格:</span>
    <input type="text"name="price" value=${updateProduct.price}>
    <br/>
    <span>商品状态:</span>
    <input type="text"name="status" value=${updateProduct.status}>
    <br/>
    <span>主图片更改</span>
